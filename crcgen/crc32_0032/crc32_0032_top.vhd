...
architecture RTL of crc32_0032_gen is
    signal   curr_crc :  std_logic_vector(31 downto 0); 
    signal   next_crc :  std_logic_vector(31 downto 0);
begin
    U: entity work.crc32_0032 port map(c => curr_crc, d => DATA, o => next_crc);
...
begin
    ...
    CRCGEN: entity work.crc32_0032_gen 
